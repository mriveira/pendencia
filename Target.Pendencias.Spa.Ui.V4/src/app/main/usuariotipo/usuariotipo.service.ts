...
export class UsuarioTipoService extends ServiceBase {
    ...
    constructor(private api: ApiService<any>,private serviceFields: UsuarioTipoServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
	...
	getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('UsuarioTipo').getDataCustom(filters);
    }

	getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('UsuarioTipo').getDataListCustom(filters);
    }
    ...
    {
        return this.api.setResource('UsuarioTipo').export(filters);
    }
}
