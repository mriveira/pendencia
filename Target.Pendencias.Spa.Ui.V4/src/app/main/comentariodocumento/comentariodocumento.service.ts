...
export class ComentarioDocumentoService extends ServiceBase {
    ...
    constructor(private api: ApiService<any>,private serviceFields: ComentarioDocumentoServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
	...
	getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('ComentarioDocumento').getDataCustom(filters);
    }

	getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('ComentarioDocumento').getDataListCustom(filters);
    }
    ...
    {
        return this.api.setResource('ComentarioDocumento').export(filters);
    }
}
