...
export class PendeciaPrioridadeService extends ServiceBase {
    ...
    constructor(private api: ApiService<any>,private serviceFields: PendeciaPrioridadeServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
	...
	getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('PendeciaPrioridade').getDataCustom(filters);
    }

	getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('PendeciaPrioridade').getDataListCustom(filters);
    }
    ...
    {
        return this.api.setResource('PendeciaPrioridade').export(filters);
    }
}
