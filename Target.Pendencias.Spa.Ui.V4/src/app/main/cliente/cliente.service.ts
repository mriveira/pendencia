...
export class ClienteService extends ServiceBase {
    ...
    constructor(private api: ApiService<any>,private serviceFields: ClienteServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
	...
	getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('Cliente').getDataCustom(filters);
    }

	getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('Cliente').getDataListCustom(filters);
    }
    ...
    {
        return this.api.setResource('Cliente').export(filters);
    }
}
