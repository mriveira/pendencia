...
export class PendenciaTipoService extends ServiceBase {
    ...
    constructor(private api: ApiService<any>,private serviceFields: PendenciaTipoServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
	...
	getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('PendenciaTipo').getDataCustom(filters);
    }

	getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('PendenciaTipo').getDataListCustom(filters);
    }
    ...
    {
        return this.api.setResource('PendenciaTipo').export(filters);
    }
}
