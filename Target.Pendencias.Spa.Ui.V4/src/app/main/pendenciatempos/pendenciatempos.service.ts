...
export class PendenciaTemposService extends ServiceBase {
    ...
    constructor(private api: ApiService<any>,private serviceFields: PendenciaTemposServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
	...
	getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('PendenciaTempos').getDataCustom(filters);
    }

	getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('PendenciaTempos').getDataListCustom(filters);
    }
    ...
    {
        return this.api.setResource('PendenciaTempos').export(filters);
    }
}
