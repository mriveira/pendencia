...
export class FluxoTrabalhoStatusService extends ServiceBase {
    ...
    constructor(private api: ApiService<any>,private serviceFields: FluxoTrabalhoStatusServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
	...
	getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('FluxoTrabalhoStatus').getDataCustom(filters);
    }

	getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('FluxoTrabalhoStatus').getDataListCustom(filters);
    }
    ...
    {
        return this.api.setResource('FluxoTrabalhoStatus').export(filters);
    }
}
