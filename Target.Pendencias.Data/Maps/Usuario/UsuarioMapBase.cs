...
namespace Target.Pendencias.Data.Map
{
    public abstract class UsuarioMapBase 
    {
        ...
        public UsuarioMapBase(EntityTypeBuilder<Usuario> type)
        {
            ...
            type.Property(t => t.Foto).HasColumnName("Foto").HasColumnType("varchar(200)");
            type.Property(t => t.Email).HasColumnName("Email").HasColumnType("varchar(200)");
            type.Property(t => t.Senha).HasColumnName("Senha").HasColumnType("varchar(10)");
