...
namespace Target.Pendencias.Domain.Services
{
    public class PendenciaEventosServiceBase : ServiceBase<PendenciaEventos>
    {
        ...
        public virtual void Remove(PendenciaEventos pendenciaeventos)
        {
		...
		public virtual async Task<PendenciaEventos> GetDefaultInstance(dynamic model, CurrentUser user)
        {
